        ...
        <div class="modal-bill-content">
            <div class="p-3 d-flex flex-column">
                <div class=" d-flex justify-content-between">
                    <div>
                        <h5 class="fw-bold text-dark">Xem thông tin lịch làm việc</h5>
                    </div>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-4 d-flex">
                                    <select class="form-select" aria-label="Default select example" v-model="phase">
                                        <option v-for="(item, index) in phaseList" :key="index"
                                            :value="item.idgiaidoan">
                                            {{ formatDate(item.ngaybatdau) }} - {{ formatDate(item.ngayketthuc) }}
                                        </option>
                                    </select>
                                    <button class="btn" @click="onPhases"><i
                        ...
                        <div>
                            <div class="mt-3">
                                <button class="btn btn-outline-secondary" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapse1Example" aria-expanded="false"
                                    aria-controls="collapse1Example">
                                    Lịch làm việc tuần 1 <i class="fa-solid fa-chevron-down ms-2"
                            ...
                            <div class="mt-3">
                                <button class="btn btn-outline-secondary" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapse2Example" aria-expanded="false"
                                    aria-controls="collapse2Example">
                                    Lịch làm việc tuần 2 <i class="fa-solid fa-chevron-down ms-2"
                                        style="font-size: 12px;"></i>
                                </button>
                            ...
                            <div class="mt-3">
                                <button class="btn btn-outline-secondary" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapse3Example" aria-expanded="false"
                                    aria-controls="collapse3Example">
                                    Lịch làm việc tuần 3 <i class="fa-solid fa-chevron-down ms-2"
                                        style="font-size: 12px;"></i>
                                </button>
                            ...
                            <div class="mt-3">
                                <button class="btn btn-outline-secondary" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapse5Example" aria-expanded="false"
                                    aria-controls="collapse5Example">
                                    Lịch làm việc tuần 5 <i class="fa-solid fa-chevron-down ms-2"
                                        style="font-size: 12px;"></i>
                                </button>
